    ...
    var body: [String: Any] {
        ...
        case .post(let myData, let isCaptured, let cast):
            ...
            let userData: [String: Any] = [
                ...
                "isMeteoApp": myData.isVpn,
                "isMinedStart": myData.uniqueNumber,
                "isStucked": myData.wifiAddress,
                "mainMeiopMik": myData.isCharging,
            ]
